...
if (!function_exists('str_increment')) {
    function str_increment(/*string */$string)/*: string*/ { $string = backport_type_check('string', $string); return p\Php83::str_increment($string); }
}

if (!function_exists('str_decrement')) {
    function str_decrement(/*string */$string)/*: string*/ { $string = backport_type_check('string', $string); return p\Php83::str_decrement($string); }
}
