...
final class Mbstring
{
    ...
    {
        list($haystack, $needle) = str_replace(self::SIMPLE_CASE_FOLD[0], self::SIMPLE_CASE_FOLD[1], [
    ...
    public static function mb_trim(/*string */$string, /*?string */$characters, /*?string */$encoding = null)/*: string*/
    {
        $string = backport_type_check('string', $string);
    ...
    public static function mb_ltrim(/*string */$string, /*?string */$characters, /*?string */$encoding = null)/*: string*/
    {
        $string = backport_type_check('string', $string);
    ...
    public static function mb_rtrim(/*string */$string, /*?string */$characters, /*?string */$encoding = null)/*: string*/
    {
        $string = backport_type_check('string', $string);
    ...
    {
        $errorFormat = backport_type_check('string', $errorFormat);
