...
class WithSqlite_hotfixForSqliteSchemaBuilder extends SQLiteConnection {
...
trait WithSqlite
{
    ...
    protected function hotfixForSqliteSchemaBuilder()
    {
        Connection::resolverFor('sqlite', static function ($connection, $database, $prefix, $config) {
            return new WithSqlite_hotfixForSqliteSchemaBuilder($connection, $database, $prefix, $config);
        });
    }
}
