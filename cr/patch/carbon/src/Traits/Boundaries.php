...
trait Boundaries
{
    ...
    {
        return $this->subDays((7 + $this->dayOfWeek - (isset($weekStartsAt) ? $weekStartsAt : $this->firstWeekDay)) % 7)->startOfDay();
    }
    ...
    {
        return $this->addDays((7 - $this->dayOfWeek + (isset($weekEndsAt) ? $weekEndsAt : $this->lastWeekDay)) % 7)->endOfDay();
    }
