...
trait WithLaravelMigrationsForTestCase
{
    use InteractsWithWorkbenchAndTestCase;
    ...
    {
        $workbenchAttributes = static::cachedConfigurationForWorkbench()->getWorkbenchAttributes();
        /** @var bool $loadLaravelMigrations */
        $loadLaravelMigrations = isset($workbenchAttributes['install']) ? $workbenchAttributes['install'] : false;
