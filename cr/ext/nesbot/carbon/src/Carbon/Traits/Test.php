...
trait Test
{
    ...
    {
        if ($testNow) {
            self::$testDefaultTimezone = isset(self::$testDefaultTimezone) ? self::$testDefaultTimezone : date_default_timezone_get();
        }
        ...
        if (!$useDateInstanceTimezone) {
            ...
            self::setDefaultTimezone(isset($tzName) ? $tzName : (isset(self::$testDefaultTimezone) ? self::$testDefaultTimezone : 'UTC'), $now);
        }
