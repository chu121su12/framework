...
class JobWatcher extends Watcher
{
    ...
    public function recordJob($connection, $queue, array $payload)
    {
        ...
        Telescope::recordJob(
            $entry = IncomingEntry::make($content)
                        ->withFamilyHash(isset($content['data']) && isset($content['data']['batchId']) ? $content['data']['batchId'] : null)
    ...
    public function recordProcessedJob(JobProcessed $event)
    {
        ...
        $eventJobPayload = $event->job->payload();

        $uuid = isset($eventJobPayload['telescope_uuid']) ? $eventJobPayload['telescope_uuid'] : null;
