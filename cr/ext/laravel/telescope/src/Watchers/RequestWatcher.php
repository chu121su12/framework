...
class RequestWatcher extends Watcher
{
    ...
    public function recordRequest(RequestHandled $event)
    {
        ...
        $eventRequestRouteMiddleware = optional($event->request->route())->gatherMiddleware();
        ...
        Telescope::recordRequest(IncomingEntry::make([
            ...
            'middleware' => array_values(isset($eventRequestRouteMiddleware) ? $eventRequestRouteMiddleware : []),
    ...
    protected function shouldIgnoreHttpMethod($event)
    {
        return in_array(
            ...
            collect(isset($this->options['ignore_http_methods']) ? $this->options['ignore_http_methods'] : [])->map(function ($method) {
