...
class MailWatcher extends Watcher
{
    ...
    protected function getMailable($event)
    {
        ...
        return isset($event->data['__telescope_mailable']) ? $event->data['__telescope_mailable'] : '';
    }
    ...
    protected function getQueuedStatus($event)
    {
        ...
        return isset($event->data['__telescope_queued']) ? $event->data['__telescope_queued'] : false;
    }
     ...
     * @return array|null
     */
    protected function formatAddresses(/*?*/array $addresses = null)
    {
    ...
    private function tags($message, $data)
    {
        return array_merge(
            ...
            isset($data['__telescope']) ? $data['__telescope'] : []
        );
    }
}
