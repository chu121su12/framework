...
if ((isset($serverState) && isset($serverState['octaneConfig']) && isset($serverState['octaneConfig']['max_execution_time']) ? $serverState['octaneConfig']['max_execution_time'] : 0) > 0) {
    $timerTable = TableFactory::make(isset($serverState['octaneConfig']) && isset($serverState['octaneConfig']['max_timer_table_size']) ? $serverState['octaneConfig']['max_timer_table_size'] : 250);
