...
trait InstallsFrankenPhpDependencies
{
    ...
    protected function downloadFrankenPhpBinary()
    {
        ...
        switch (true) {
            case PHP_OS_FAMILY === 'Linux' && $arch === 'x86_64': $assetName = 'frankenphp-linux-x86_64'; break;
            case PHP_OS_FAMILY === 'Linux' && $arch === 'aarch64': $assetName = 'frankenphp-linux-aarch64'; break;
            case PHP_OS_FAMILY === 'Darwin': $assetName = "frankenphp-mac-$arch"; break;
            default: $assetName = null;
        }
        ...
        $response = Http::accept('application/vnd.github+json')
            ...
            ->throw_(function () { return $this->components->error('Failed to download FrankenPHP.'); });
