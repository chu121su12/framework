...
class YamlFileLoader extends FileLoader
{
    ...
    protected function parseRoute(RouteCollection $collection, $name, array $config, $path)
    {
        ...
        if (isset($config['alias'])) {
            ...
            $deprecation = isset($config['deprecated']) ? $config['deprecated'] : null;
            if (null !== $deprecation) {
                $alias->setDeprecated(
                    $deprecation['package'],
                    $deprecation['version'],
                    isset($deprecation['message']) ? $deprecation['message'] : ''
                );
            }
        ...
        $routes->setSchemes(isset($config['schemes']) ? $config['schemes'] : []);
        $routes->setMethods(isset($config['methods']) ? $config['methods'] : []);
        $routes->setCondition(isset($config['condition']) ? $config['condition'] : null);
