        ...
        <div class="container">
            <h2 class="exception-hierarchy">
                <?php foreach (array_reverse($exception->getAllPrevious(), true) as $index => $previousException) { ?>
                    ...
                    <span class="icon"><?= $this->doInclude('assets/images/chevron-right.svg'); ?></span>
                <?php } ?>
    ...
    <div class="exception-message-wrapper">
        <div class="container">
            ...
            <div class="exception-illustration hidden-xs-down">
                <?= $this->doInclude('assets/images/symfony-ghost.svg.php'); ?>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="sf-tabs">
        <div class="tab">
            ...
            <div class="tab-content">
                <?php
                foreach ($exceptionAsArray as $i => $e) {
                    echo $this->doInclude('views/traces.html.php', [
                        'exception' => $e,
                        'index' => $i + 1,
        ...
        <div class="tab <?= !$logger->getLogs() ? 'disabled' : ''; ?>">
            ...
            <div class="tab-content">
                <?php if ($logger->getLogs()) { ?>
                    <?= $this->doInclude('views/logs.html.php', ['logs' => $logger->getLogs()]); ?>
                <?php } else { ?>
                    <div class="empty">
                        <p>No log messages</p>
                    </div>
        ...
        <div class="tab">
            ...
            <div class="tab-content">
                <?php
                foreach ($exceptionAsArray as $i => $e) {
                    echo $this->doInclude('views/traces_text.html.php', [
                        'exception' => $e,
                        'index' => $i + 1,
