    ...
    public function all()
    {
        if ($this->priorities) {
            ...
            uksort($this->routes, static function ($n1, $n2) use ($priorities, $keysOrder) {
                return backport_spaceship_operator((isset($priorities[$n2]) ? $priorities[$n2] : 0), (isset($priorities[$n1]) ? $priorities[$n1] : 0))
                    ?: backport_spaceship_operator($keysOrder[$n1], $keysOrder[$n2]);
            });
        }
