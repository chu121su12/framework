...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    public function is(...$patterns)
    {
        ...
        return collect($patterns)->contains(function ($pattern) use ($path) { return Str::is($pattern, $path); });
    }
    ...
    public function fullUrlIs(...$patterns)
    {
        ...
        return collect($patterns)->contains(function ($pattern) use ($url) { return Str::is($pattern, $url); });
    }
            ...
            $request->getInputSource()
                    ->replace(collect($input)->reduce(
                        function ($requestInput, $value, $key) {
                            return data_set($requestInput, $key, $value);
                        },
    ...
    {
        if (! isset($this->json)) {
            $this->json = new InputBag((array) backport_json_decode($this->getContent() ?: '[]', true));
        }
