...
trait HasAttributes
{
    ...
    protected function addCastAttributesToArray(array $attributes, array $mutatedAttributes)
    {
        foreach ($this->getCasts() as $key => $value) {
            ...
            if ($this->isEnumCastable($key) && (! (isset($attributes[$key]) ? $attributes[$key] : null) instanceof Arrayable)) {
    ...
    {
        return Json::decode(isset($value) ? $value : '', ! $asObject);
    }
     ...
     * @return string
     */
    protected function castAttributeAsEncryptedString($key,
        #[\SensitiveParameter]
        $value
    )
    {
     ...
     * @return string
     */
    protected function castAttributeAsHashedString($key,
        #[\SensitiveParameter]
        $value
    )
    {
