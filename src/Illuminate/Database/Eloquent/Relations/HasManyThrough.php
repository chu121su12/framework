...
class HasManyThrough extends Relation
{
    ...
    public function one()
    {
        return HasOneThrough::noConstraints(function () { return new HasOneThrough(
            $this->getQuery(),
            $this->farParent,
            $this->throughParent,
    ...
    {
        try {
            return $this->getQuery()->withSavepointIfNeeded(function () use ($attributes, $values) { return $this->create(array_merge($attributes, $values)); });
