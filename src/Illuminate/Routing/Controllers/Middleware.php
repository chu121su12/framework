...
class Middleware
{
    ...
    {
        $this->middleware = backport_type_check('\Closure|string|array', $middleware);
        $this->only = backport_type_check('?array', $only);
        $this->except = backport_type_check('?array', $except);
    }
