...
class Dispatcher implements DispatcherContract
{
    ...
    {
        return ((isset($listener->afterCommit) ? $listener->afterCommit : null) ||
    ...
    protected function propagateListenerOptions($listener, $job)
    {
        return tap($job, function ($job) use ($listener) {
            ...
            $job->backoff = method_exists($listener, 'backoff') ? $listener->backoff(...$data) : (isset($listener->backoff) ? $listener->backoff : null);
            ...
            $job->failOnTimeout = isset($listener->failOnTimeout) ? $listener->failOnTimeout : null;
