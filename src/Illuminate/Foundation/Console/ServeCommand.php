...
class ServeCommand extends Command
{
    ...
    {
        $process = SymfonyHelper::newProcess($this->serverCommand(), public_path(), collect($_ENV)->mapWithKeys(function ($value, $key) use ($hasEnvironment) {
        ...
        $this->trap(function () { return [SIGTERM, SIGINT, SIGHUP, SIGUSR1, SIGUSR2, SIGQUIT]; }, function ($signal) use ($process) {
        ...
        $lines
            ...
            ->each(function ($line) {
                ...
                if (str($line)->contains(' Accepted')) {
                    ...
                    list($startDate, $file, $startMicrotime) = $this->requestsPool[$requestPort];
