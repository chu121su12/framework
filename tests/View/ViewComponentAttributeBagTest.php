...
class ViewComponentAttributeBagTest extends TestCase
{
    public function testAttributeRetrieval()
    {
        ...
        $this->assertSame('class="mt-4 font-bold" name="test"', (string) $bag->class_('mt-4'));
        $this->assertSame('class="mt-4 font-bold" name="test"', (string) $bag->class_(['mt-4']));
        $this->assertSame('class="mt-4 ml-2 font-bold" name="test"', (string) $bag->class_(['mt-4', 'ml-2' => true, 'mr-2' => false]));

        $bag = new ComponentAttributeBag(['class' => 'font-bold', 'name' => 'test', 'style' => 'margin-top: 10px']);
        $this->assertSame('class="mt-4 ml-2 font-bold" style="margin-top: 10px;" name="test"', (string) $bag->class_(['mt-4', 'ml-2' => true, 'mr-2' => false]));
        ...
        $this->assertSame('class="mt-4 ml-2 font-bold" style="margin-top: 10px; font-weight: bold;" name="test"', (string) $bag->class_(['mt-4', 'ml-2' => true, 'mr-2' => false]));
