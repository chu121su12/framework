...
<?php \$component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
    ...
    public function testClasslessComponentsWithAnonymousComponentPath()
    {
        ...
        $factory->shouldReceive('exists')->andReturnUsing(function ($arg) {
            return $arg === hash(BACKPORT_HASH_xxh128, 'test-directory').'::panel.index';
        });
        ...
        $blade->shouldReceive('getAnonymousComponentPaths')->once()->andReturn([
            ['path' => 'test-directory', 'prefix' => null, 'prefixHash' => hash(BACKPORT_HASH_xxh128, 'test-directory')],
        ]);
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Illuminate\View\AnonymousComponent', 'panel', ['view' => '".hash(BACKPORT_HASH_xxh128, 'test-directory')."::panel.index','data' => []])
<?php if (isset(\$attributes) && \$attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes([]); ?>\n".
    ...
    public function testClasslessIndexComponentsWithAnonymousComponentPath()
    {
        ...
        $factory->shouldReceive('exists')->andReturnUsing(function ($arg) {
            return $arg === hash(BACKPORT_HASH_xxh128, 'test-directory').'::panel';
        });
        ...
        $this->assertSame("##BEGIN-COMPONENT-CLASS##@component('Illuminate\View\AnonymousComponent', 'panel', ['view' => '".hash(BACKPORT_HASH_xxh128, 'test-directory')."::panel','data' => []])
<?php if (isset(\$attributes) && \$attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php \$attributes = \$attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php \$component->withAttributes([]); ?>\n".
