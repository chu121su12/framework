...
class BladeComponentsTest extends AbstractBladeTestCase
{
    ...
    {
        $this->assertSameStringDifferentLineEndings('<?php if (isset($component)) { $__componentOriginal35bda42cbf6f9717b161c4f893644ac7a48b0d98 = $component; } ?>
...
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>', $this->compiler->compileString('@component(\'Test::class\', \'test\', ["foo" => "bar"])'));
    ...
    public function testEndComponentsAreCompiled()
    {
        ...
        $this->assertSameStringDifferentLineEndings('<?php if (isset($__componentOriginal0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33)): ?>
