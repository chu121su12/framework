...
class BladeIncludesTest extends AbstractBladeTestCase
{
    ...
    public function testIncludeUnlessesAreCompiled()
    {
        ...
        $this->assertSame('<?php echo $__env->renderUnless(isset($undefined) ? $undefined : true, \'foo\', \Illuminate\Support\Arr::except(get_defined_vars(), [\'__data\', \'__path\'])); ?>', $this->compiler->compileString('@includeUnless($undefined ?? true, \'foo\')'));
    }
