...
class SupportCarbonTest extends TestCase
{
    ...
    {
        $this->assertTrue(Carbon::now()->when(null, function (Carbon $carbon) { return $carbon->addDays(1); })->isToday());
        $this->assertTrue(Carbon::now()->when(true, function (Carbon $carbon) { return $carbon->addDays(1); })->isTomorrow());
    }
}
