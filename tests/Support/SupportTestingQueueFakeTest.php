...
class SupportTestingQueueFakeTest extends TestCase
{
    ...
    public function testItCanSerializeAndRestoreJobs()
    {
        ...
        $this->fake->assertPushed(JobWithSerialization::class, function ($job) { return $job->value === 'hello'; });
        ...
        $fake->assertPushed(
            ...
            function ($job) { return $job->value === 'hello-serialized-unserialized'; }
        );
    }
    ...
    public function testItCanFakePushedJobsWithClassAndPayload()
    {
        ...
        $fake->assertPushed('JobStub', function ($job, $queue, $payload) { return $payload === ['job' => 'payload']; });
    }
}
