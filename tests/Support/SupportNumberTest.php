...
class SupportNumberTest extends TestCase
{
    public function testFormat()
    {
        ...
        $this->assertSame('100,000.123', Number::format(100000.1234, /*$precision = */null, /*maxPrecision:*/ 3));
        $this->assertSame('100,000.124', Number::format(100000.1236, /*$precision = */null, /*maxPrecision:*/ 3));
        ...
        $this->assertSame('0.123', Number::format(0.1234, /*$precision = */null, /*maxPrecision:*/ 3));
    ...
    public function testSpelloutWithThreshold()
    {
        ...
        $this->assertSame('11', Number::spell(11, $locale = null, $after = null, /*until: */10));

        $this->assertSame('ten thousand', Number::spell(10000, $locale = null, $after = null, /*until: */50000));
        $this->assertSame('100,000', Number::spell(100000, $locale = null, $after = null, /*until: */50000));
    }
    ...
    public function testToPercent()
    {
        ...
        $this->assertSame('100.123%', Number::percentage(100.1234, /*$precision = */null, /*maxPrecision: */3));
    ...
    public function testBytesToHuman()
    {
        ...
        $this->assertSame('1.234 KB', Number::fileSize(1264.12345, /*$precision = */null, /*maxPrecision: */3));
    ...
    public function testToHuman()
    {
        ...
        $this->assertSame('1 thousand', Number::forHumans(1000, /*$precision = */null, /*maxPrecision: */2));
        $this->assertSame('1 thousand', Number::forHumans(1230));
        $this->assertSame('1.2 thousand', Number::forHumans(1230, /*$precision = */null, /*maxPrecision: */1));
        ...
        $this->assertSame('-1 thousand', Number::forHumans(-1000));
        $this->assertSame('-1.23 thousand', Number::forHumans(-1234, /*precision: */2));
        $this->assertSame('-1.2 thousand', Number::forHumans(-1234, /*$precision = */null, /*maxPrecision: */1));
        $this->assertSame('-1 million', Number::forHumans(-1000000));
        $this->assertSame('-1 billion', Number::forHumans(-1000000000));
        $this->assertSame('-1 trillion', Number::forHumans(-1000000000000));
        $this->assertSame('-1.1 trillion', Number::forHumans(-1100000000000, /*$precision = */null, /*maxPrecision: */1));
        $this->assertSame('-1 quadrillion', Number::forHumans(-1000000000000000));
        $this->assertSame('-1 thousand quadrillion', Number::forHumans(-1000000000000000000));
    }
    ...
    public function testSummarize()
    {
        ...
        $this->assertSame('1K', Number::abbreviate(1000, /*$precision = */null, /*maxPrecision: */2));
        $this->assertSame('1K', Number::abbreviate(1230));
        $this->assertSame('1.2K', Number::abbreviate(1230, /*$precision = */null, /*maxPrecision: */1));
        ...
        $this->assertSame('-1K', Number::abbreviate(-1000));
        $this->assertSame('-1.23K', Number::abbreviate(-1234, /*precision: */2));
        $this->assertSame('-1.2K', Number::abbreviate(-1234, /*$precision = */null, /*maxPrecision: */1));
        $this->assertSame('-1M', Number::abbreviate(-1000000));
        $this->assertSame('-1B', Number::abbreviate(-1000000000));
        $this->assertSame('-1T', Number::abbreviate(-1000000000000));
