...
class MailMessageTest_testItAttachesFilesViaAttachableContractFromPath_class implements Attachable
        {
...
class MailMessageTest_testItAttachesFilesViaAttachableContractFromData_class implements Attachable
        {
            public function toMailAttachment()
            {
                return Attachment::fromData(function () { return 'expected attachment body'; }, 'foo.jpg')
                    ->withMime('image/png');
            }
        }

class MailMessageTest_testItEmbedsFilesViaAttachableContractFromPath_class implements Attachable
        {
            public function toMailAttachment()
            {
                return Attachment::fromPath(__DIR__.'/foo.jpg')->as_('baz')->withMime('image/png');
            }
        }

class MailMessageTest_testItGeneratesARandomNameWhenAttachableHasNone_class implements Attachable
        {
            public function toMailAttachment()
            {
                return Attachment::fromPath(__DIR__.'/foo.jpg');
...
class MailMessageTest extends TestCase
{
    ...
    public function testItAttachesFilesViaAttachableContractFromPath()
    {
        ...
        $this->message->attach(new MailMessageTest_testItAttachesFilesViaAttachableContractFromPath_class);
    ...
    {
        $this->message->attach(new MailMessageTest_testItAttachesFilesViaAttachableContractFromData_class);
    ...
    public function testItEmbedsFilesViaAttachableContractFromPath()
    {
        ...
        $cid = $this->message->embed(new MailMessageTest_testItEmbedsFilesViaAttachableContractFromPath_class);
    ...
    public function testItGeneratesARandomNameWhenAttachableHasNone()
    {
        ...
        $cid = $this->message->embed(new MailMessageTest_testItGeneratesARandomNameWhenAttachableHasNone_class);
